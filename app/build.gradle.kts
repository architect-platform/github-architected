...
dependencies {
  ...
  implementation("com.fasterxml.jackson.core:jackson-databind:2.19.2") // core Jackson
  implementation("com.fasterxml.jackson.module:jackson-module-kotlin:2.19.2") // Kotlin support
}
